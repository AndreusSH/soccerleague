...
const ErrorPage = () => {
    ...
    // Define a function to handle the button click and navigate to the home page.
...
<section class="bg-white dark:bg-gray-900 ">
    <div class="container flex items-center min-h-screen px-6 py-12 mx-auto">
        <div class="flex flex-col items-center max-w-sm mx-auto text-center">
            ...
            <h1 class="mt-3 text-2xl font-semibold text-gray-800 dark:text-white md:text-3xl">You must be logged in to access the chat!</h1>
            <p class="mt-4 text-gray-500 dark:text-gray-400">Please Log In and try again</p>

            <div class="flex items-center w-full mt-6 gap-x-3 shrink-0 sm:w-auto">
                <button onClick={handleGoToHomeClick} 
